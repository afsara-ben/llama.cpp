...
static uint64_t ggml_kernel_MUL_MV_Q2_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_Q3_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_Q4_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_Q5_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_Q6_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_IQ2_XXS_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_IQ2_XS_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_IQ3_XXS_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_IQ3_S_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_IQ2_S_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_IQ1_S_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_IQ1_M_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_IQ4_NL_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_IQ4_XS_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_Q4_0_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_Q4_1_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_Q5_0_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_Q5_1_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_Q8_0_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_F16_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_F32_F32_count = 0;
static uint64_t ggml_kernel_MUL_MV_BF16_F32_count = 0;   
static uint64_t ggml_kernel_MUL_MV_BF16_BF16_count = 0;
static uint64_t ggml_kernel_MUL_MV_F32_F16_count = 0;
static uint64_t ggml_kernel_MUL_MV_F16_F16_count = 0;

static uint64_t ggml_kernel_MUL_MM_F32_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_F16_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_BF16_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q4_0_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q4_1_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q5_0_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q5_1_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q8_0_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q2_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q3_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q4_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q5_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_Q6_K_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_IQ2_XXS_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_IQ2_XS_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_IQ3_XXS_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_IQ3_S_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_IQ2_S_F32_count = 0;
static uint64_t ggml_kernel_MUL_MM_IQ1_S_F32_count = 0;
        ...
        case GGML_OP_MUL_MAT_ID:
            {
                ...
                // for now the matrix-matrix multiplication kernel only works on A14+/M1+ SoCs -- aben:take note
                // AMD GPU and older A-chips will reuse matrix-vector multiplication kernel
                if ([device supportsFamily:MTLGPUFamilyApple7] &&
                        ne00 % 32 == 0 && ne00 >= 64 &&
...
//aben 04/22/25: this is the main function that will be called to compute the graph
